...
const TECHNIQUE_OPTIONS = [
  ...
  "Doble ángulo/Negativo",
  "Entrenamiento de pico",
  "Auxotónico",
  "Auxotónico/Negativo",
  "Fallo muscular máximo",
  "Pirámide descendente",
  "Pirámide ascendente",
  "Biseriado",
  "Híbrido",
  "Circuitos",
  "Déficit bilateral 1 mano",
  "TUT (1 minuto)",
  "Push pull",
  ...
  useEffect(() => {
    const fetchWorkouts = async () => {
      try {
        ...
        toast.error("Error al cargar los ejercicios disponibles");
      } finally {
        setIsLoading(false);
      }
    };

// components/macros/macros-calculator-form.tsx
"use client";
...
export function MacrosCalculatorForm({
  ...
  const handleRecalculate = () => {
    // Si hay plan de alimentación y ya hay macros calculados, mostrar alerta
  ...
  const performCalculation = async (data: FormData) => {
    ...
    try {
      ...
      // Mensaje diferente si hay plan de alimentación
      if (hasMealPlan && currentMacros) {
        toast.success(
  ...
  const onSubmit = async (data: FormData) => {
    // Si hay plan de alimentación y ya hay macros calculados, confirmar primero
    if (hasMealPlan && currentMacros) {

...
export default function PricingPage() {
  ...
  const getPlanUrl = (plan: Plan) => {
    return interval === "monthly" ? plan.monthlyPriceUrl : plan.anualPriceUrl;
  };
          ...
          >
            ...
            <CardFooter>
              {getPlanUrl(plan) ? (
                ...
                >
                  <Link href={getPlanUrl(plan)!} target="_blank" rel="noopener noreferrer">
                    Comenzar Ahora
                  </Link>
                </Button>
              ) : (

...
export default withAuth(
  function middleware(req) {
    ...
    // Proteger ruta /system - solo usuarios con rol "system"
    if (path.startsWith("/system") && token?.role !== "system") {
    ...
    // Redirigir a /system si el usuario es system y trata de acceder a /dashboard
    if (path === "/dashboard" && token?.role === "system") {
